...
var templates = []Template{
	...
	},
	{
		...
		Params: []Param{
			...
			{Name: "put_delta_max", Type: "number", Default: 0.0, Min: 0, Max: 1, Help: "卖 put 的 delta 绝对值上限（0 = 不限制）"},
			{Name: "call_delta_max", Type: "number", Default: 0.0, Min: 0, Max: 1, Help: "卖 call 的 delta 上限（0 = 不限制）"},
